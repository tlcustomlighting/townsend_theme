...
class My_Theme_Options {
	...
	public function add_pages() {
		...
		$admin_page = add_theme_page( __( 'Global Options' ), __( 'Global Options' ), 'manage_options', 'mytheme-options', array( &$this, 'display_page' ) );
	...
	public function get_settings() {
		...
		===========================================*/
										...
										$this->settings['header_message'] = array(
			'title'   => __( 'Header Message' ),
			'type'    => 'textarea',
			'section' => 'general'
		);
		
		
												$this->settings['client_question'] = array(
			'title'   => __( 'Client Login Question' ),
			'type'    => 'textarea',
			'section' => 'general'
		);
		
		
								$this->settings['company_address'] = array(
			...
			'section' => 'general'
										...
										$this->settings['company_phone'] = array(
			'title'   => __( 'Company Phone' ),
			'type'    => 'text',
			'section' => 'general'
		);
		
		
												$this->settings['company_fax'] = array(
			...
			'section' => 'general'
														...
														$this->settings['company_email'] = array(
			...
			'section' => 'general'
																...
																$this->settings['company_email_2'] = array(
			'title'   => __( 'Company Email 2' ),
			'type'    => 'text',
			'section' => 'general'
		);
									...
									$this->settings['company_address_europe'] = array(
			'title'   => __( 'Company Address (Europe)' ),
			'type'    => 'textarea',
			'section' => 'general'
		);
		
		
										$this->settings['company_phone_europe'] = array(
			'title'   => __( 'Company Phone (Europe)' ),
			'type'    => 'text',
			'section' => 'general'
		);
														...
														$this->settings['company_email_europe'] = array(
			'title'   => __( 'Company Email (Europe)' ),
			'type'    => 'text',
			'section' => 'general'
		);
			...
			'section' => 'social'
						...
						$this->settings['pinterest_link'] = array(
			'title'   => __( 'Pinterest Link' ),
			'type'    => 'text',
			'section' => 'social'
		);
			...
			'section' => 'social'
						...
						$this->settings['google_plus_link'] = array(
			...
			'section' => 'social'
						...
						$this->settings['blogger_link'] = array(
			'title'   => __( 'Blogger Link' ),
			'type'    => 'text',
			'section' => 'social'
		);		
		
		
								$this->settings['angies_link'] = array(
			'title'   => __( 'Angies Link' ),
			'type'    => 'text',
			'section' => 'social'
		);		
